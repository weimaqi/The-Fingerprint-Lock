...
u8 OV7670_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin  = GPIO_Pin_6 | GPIO_Pin_7 | GPIO_Pin_8 | GPIO_Pin_9 | GPIO_Pin_11 ; //PD0~7 输入 上拉
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN;
	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;
 	GPIO_Init(GPIOC, &GPIO_InitStructure);
	
	GPIO_InitStructure.GPIO_Pin  = GPIO_Pin_8 ; //PD0~7 输入 上拉
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN;
	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;
 	GPIO_Init(GPIOB, &GPIO_InitStructure);
	
	GPIO_InitStructure.GPIO_Pin  = GPIO_Pin_5 | GPIO_Pin_6; //PD0~7 输入 上拉
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN;
	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;
	...
	GPIO_SetBits(GPIOG, GPIO_Pin_9 | GPIO_Pin_15);
	...
	GPIO_InitStructure.GPIO_Pin  = GPIO_Pin_8; 	//PB3 输入 上拉
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN;
